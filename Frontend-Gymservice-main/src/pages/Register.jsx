...
const registerUrl =
  "https://origins-plaintiff-beneficial-philosophy.trycloudflare.com/register";
...
const Register = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        console.log(result);
        localStorage.setItem("affiliator_email", formData.affiliator_email);
